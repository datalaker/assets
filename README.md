...
2. [Learning Framework](orientation/learning-framework.drawio.svg)
3. Curriculum Walkthrough

### Workspace Setup

1. [Install Conda and Jupyter](workspace-setup/install-conda-jupyter.md)
2. [Install Visual Studio Code](workspace-setup/install-visual-studio.md)
3. [Create AWS Free-tier Account](workspace-setup/create-aws-account.md)
4. [Setup AWS credentials in your system](workspace-setup/setup-aws-credentials.md)
5. [Create GitHub Account](workspace-setup/create-github-account.md)
6. [Setup Github credentials in your system](workspace-setup/setup-git-credentials.md)
7. [Install DBeaver in your system](workspace-setup/install-dbeaver.md)
8. [Create Databricks Account](workspace-setup/create-databricks-account.md)

### Shell, Github and Colab Primer

1. [Common Shell Commands](primers/common-shell-commands.md)
...
1. [How Data Engineering Works](data-engineering-essentials/how-data-engineering-works.md)
2. [The Role of Data Engineering in an Organization](data-engineering-essentials/data-engineering-role.md)
3. [Data Engineering Landscape](data-engineering-essentials/2021-MAD-Landscape-v3.pdf)
4. [Data Engineering Roadmap](https://knowledgetree.notion.site/Data-Engineering-Roadmap-6e543497f9074aba89520b45b678d32f)
5. [Approaching the data pipeline architecture](https://knowledgetree.notion.site/Approaching-the-data-pipeline-architecture-214bdf596037454ca3f879894035c83f)
...
1. [Batch vs Streaming Data](data-engineering-essentials/batch-vs-stream.md)
2. [Lambda vs Kappa Big Data Architectures](data-engineering-essentials/lambda-vs-kappa.md)
3. [ELT vs ETL Pipelines](data-engineering-essentials/elt-vs-etl.md)
4. Data Lineage
5. Data Reliability
...
### Assignment-oriented Projects

1. [Data Pipeline with dbt, Airflow and Great Expectations](data-pipeline-airflow-dbt-ge)
2. [Data Pipeline with Databricks PySpark and Superset](databricks-superset-batch-pipeline)
3. [Sparkify Music Data Pipeline](sparkify-music-data-pipeline)
4. [Data Engineering with Databricks](data-engineering-with-databricks)
5. [Sakila Music Company](sakila-music-company)
6. [Funflix Media Company](funflix)

### Live Projects

> Subject to access and availability.

1. Entire Data Engineering Pipeline of a Fortune 100 company
2. AWS Data Engineering Pipeline of a Startup
3. Robust End-to-End Data Engineering and Machine Learning Pipeline of a large organization
4. Data Engineering Pipeline of an API-based Financial System of a Startup
...
1. [How to Create a Redshift Cluster]() // TODO
1. [Amazon Redshift Overview](amazon-redshift/README.md)
...
1. [Create Snowflake Account](workspace-setup/create-snowflake-account.md)
2. [Introduction to Snowflake](snowflake/README.md)
3. [[Lab] Snowflake Data Query with Python](snowflake/snowflakePython)

## Data Lakes and Lakehouses

1. [Data Lakes vs Lakehouses](data-lakes-and-lakehouses/lakes-vs-lakehouses.md)
2. [Data Lakes and Lakehouses](https://knowledgetree.notion.site/Data-Lakes-and-Lakehouses-Shared-746c1aacab4f4eb2b91b2ba706f7ba46)
3. [Understanding why Amazon S3 is the best place to build your data lake](https://youtu.be/_abfv7Efr5Q)
4. [Amazon Migrates 50 PB of Analytics Data from Oracle to AWS](https://aws.amazon.com/solutions/case-studies/amazon-migration-analytics/)
5. [From Data Lake to Lakehouse](https://medium.com/claimsforce/lakehouse-the-journey-unifying-data-lake-and-data-warehouse-bef7629c143a)
6. [Building the Lakehouse](https://bit.ly/3E0rPTk)
7. [How Woot.com built a serverless data lake on AWS](https://aws.amazon.com/de/blogs/big-data/our-data-lake-story-how-woot-com-built-a-serverless-data-lake-on-aws/)
8. [Handling CDC and SCD in Delta Lakes](data-lakes-and-lakehouses/handling-cdc-scd.png)
9. [Data Lake / Lakehouse Guide: Powered by Data Lake Table Formats (Delta Lake, Iceberg, Hudi)](https://airbyte.com/blog/data-lake-lakehouse-guide-powered-by-table-formats-delta-lake-iceberg-hudi)

## Transformation

### Primer

1. [Most Common Data Transformations](data-transformations/most-common-data-transformations.md)

### AWS Lambda Functions

1. [AWS Lambda Introduction](https://youtu.be/iUIWG0h2D84)
2. [[Lab] Converting CSV to Parquet with AWS Lambda Trigger](aws-lambda/S3_Lambda_CSV_to_Parquet.ipynb)
...
4. [[Lab] Making ETL easier with AWS Glue Studio]() // TODO
...
4. [Spark SQL Engine and Query Planning]()
4. [Spark Jobs - Stage, Shuffle, Task, Slots]()
5. [Spark Quiz & Solution [Videos]](https://knowledgetree.notion.site/Spark-Quiz-Solution-Videos-0ad90ea3035541e2af22eeaf18b738aa)
6. [[Lab] Electricity Data processing with PySpark](spark/electricity-data-processing)
7. [Distributed Computing and the difference between Hadoop and Spark](https://knowledgetree.notion.site/Distributed-Computing-and-the-difference-between-Hadoop-and-Spark-1b741e18ddf5474da3a2b941f48dcea3)
...
5. [[Lab] Databricks SQL Warehouse and Dashboard]() // TODO
6. [[Lab] Delta Lake Deep Dive](https://youtu.be/BMO90DI82Dc)

## Workflow Orchestration

### Primer

1. [What is Data Orchestration](data-orchestration/intro.md)

### Airflow

1. [Install Airflow]() // TODO: Add Airflow setup guide
2. [Getting Started with Airflow](airflow/getting-started.md)
3. [Airflow Scheduling](airflow/scheduling.md)
4. [Intro To Data Orchestration With Airflow](https://youtu.be/eum5CxOUnEU)
5. [Operating data pipeline using Airflow @ Slack](https://youtu.be/1UjZdmvIkZ0)
6. [Running Apache Airflow At Lyft](https://eng.lyft.com/running-apache-airflow-at-lyft-6e53bb8fccff)
7. [How Jellysmack Pushed Data Science Jobs Orchestration to a Production-ready Level](https://medium.com/jellysmacklabs/how-jellysmack-pushed-data-science-jobs-orchestration-to-a-production-ready-level-e92dc4786413)
...
1. [Introduction to Apache Kafka](kafka/introduction.md)
1. [Install Kafka](workspace-setup/install-kafka.md)
...
6. [[Lab] Real-time event capturing with Kafka and MongoDB]() // TODO
7. [[Lab] Real-Time ETL Pipeline with Kafka]() // TODO
...
5. [[Lab] Serverless Streaming Data on AWS](kinesis/ServerlessStreamingApp)
...
1. [[Live Project] Lambda API Gateway Latency Analysis]() // TODO
...
4. [[Lab] Analyze and Compare the Modern Data Stacks](modern-data-stack/lab_analyze_stacks.md)
...
1. [Monitoring machine learning systems at Faire](https://craft.faire.com/monitoring-machine-learning-systems-at-faire-6d5f8337e9e7)
...
1. [97 Things Every Data Engineer Should Know](https://learning.oreilly.com/library/view/97-things-every/9781492062400/) [[code]()]
...
1. [Fundamentals of Data Engineering](https://learning.oreilly.com/library/view/fundamentals-of-data/9781098108298/) [[code]()]
...
1. [Data Pipelines with Apache Airflow](https://learning.oreilly.com/videos/data-pipelines-with/9781617296901AU/) [[code]()]
...
1. [Learning Spark, 2nd Edition](https://learning.oreilly.com/library/view/learning-spark-2nd/9781492050032/) [[code](https://github.com/databricks/LearningSparkV2)]
...
1. [Beginning Apache Spark 3: With DataFrame, Spark SQL, Structured Streaming, and Spark Machine Learning Library](https://learning.oreilly.com/library/view/beginning-apache-spark/9781484273838/) [[code]()]
...
1. [Scaling Machine Learning with Spark](https://learning.oreilly.com/library/view/scaling-machine-learning/9781098106812/) [[code]()]
1. [Modern Data Engineering with Apache Spark: A Hands-On Guide for Building Mission-Critical Streaming Applications](https://learning.oreilly.com/library/view/modern-data-engineering/9781484274521/) [[code]()]
1. [Apache Spark 3 Advance Skills for Cracking Job Interviews](https://learning.oreilly.com/videos/apache-spark-3/9781803241555/) [[code]()]
1. [Apache Spark 3 for Data Engineering and Analytics with Python](https://learning.oreilly.com/videos/apache-spark-3/9781803244303/) [[code](https://github.com/PacktPublishing/Apache-Spark-3-for-Data-Engineering-and-Analytics-with-Python-)]
...
1. [Sams Teach Yourself Hadoop in 24 Hours](https://learning.oreilly.com/library/view/sams-teach-yourself/9780134456737/) [[code]()]
